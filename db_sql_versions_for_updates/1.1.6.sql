...
ALTER TABLE `transaction_detail` ADD `description` TEXT NULL AFTER `cr_amount`;
...
INSERT INTO `permission` ( `key`, `value`, `parent_id`, `created_at`, `updated_at`) VALUES
('Suplier', 'supplier-list', '51', NULL, NULL),
('Manage Supplier', 'supplier-manage', '51', NULL, NULL),
('Sale Quotations', 'quotation-sale-list', '24', NULL, NULL),
('Manage Sale Quotations', 'quotation-sale-manage', '24', NULL, NULL),
('Reports', 'manage-reports', '0', NULL, NULL),
('Reports', 'manage-reports', '98', NULL, NULL);


ALTER TABLE `accounts` CHANGE `type` `type` ENUM('customer','supplier','tax','shipping','couponcode','discount','sale','simple_product','variable_product','income') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;