...
class CreateOrdersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->enum('order_from', ['androidapp','iosapp','web','pos','addsale'])->default('androidapp');
            ...
            $table->enum('payment_method', ['cod', 'paypal','authorize_net','stripe','banktransfer','mollie','instamojo','braintree','hyperpay','razorpay','paytm','paystack','midtrans','wallet','fygaro'
            ])->default('cod');
