        ...
        for ($i = 1; $i <= 100; $i++) {
            ...
            for ($j=1;$j<=9;$j++)
            {
                ...
                $ProductCombination = ProductCombination::create(
                    ...
                    $accounts->createAccount('SUPPLIES','variable-product-' . (string)$i.' '.variationProductTitleBasedOnCombinationId($ProductCombination->id), $ProductCombination->id,'variable_product');
