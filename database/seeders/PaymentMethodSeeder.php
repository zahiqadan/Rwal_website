    ...
    public function run()
    {
        ...
        PaymentMethodSetting::insertOrIgnore([
            [
                'payment_method_id' => $paymentMethod->id,
                'key' => 'FYGARO_API_KEY',
                'value' => 'a7cb170b-c36a-4b82-8461-1e8b24f1709e',
            ],
            [
                'payment_method_id' =>$paymentMethod->id,
                'key' => 'FYGARO_SECRET_KEY',
                'value' => 'w4WPWPp84spEC6k1VHWLbsY0mG8fOvJV4-ZAJezsnHQ',
            ],
            [
                'payment_method_id' =>$paymentMethod->id,
                'key' => 'FYGARO_Button_URL',
                'value' => 'https://www.fygaro.com/en/pb/87baafd3-a1e8-42e3-be61-10a030303580',
            ]
        ]
        );
