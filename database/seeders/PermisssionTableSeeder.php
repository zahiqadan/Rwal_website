...
class PermisssionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //101
        Permission::insertOrIgnore([
            'key' => 'Manage Country Settings',
            'Value' => 'country-manage',
            'parent_id'=>60
        ...
        //106
        Permission::insertOrIgnore([
            'key' => 'Shippment With City Settings',
            'Value' => 'shippment-with-city-list',
            'parent_id'=>60
        ...
        //107
        Permission::insertOrIgnore([
            'key' => 'Manage Shippment With City Settings',
            'Value' => 'shippment-with-city-manage',
            'parent_id'=>60
        ...
        //109
        Permission::insertOrIgnore([
            'key' => 'NewsletterContact Settings',
            'Value' => 'NewsletterContact-list',
            'parent_id'=>60
        ...
        //110
        Permission::insertOrIgnore([
            'key' => 'Manage NewsletterContact Settings',
            'Value' => 'NewsletterContact-delete',
            'parent_id'=>60
