              ...
              >
                ...
                >
                  <div class="card-title mb-0 w-100">
                    <h3 class="d-inline card-label mb-0 font-weight-bold text-body">
                      Order
                      <span class="text-black-50">#{{ orders.order_id }}</span>
                    </h3>
                    <!-- <a href="" id="print_invoice">Print Invoice</a> -->
                    <button class="float-right btn btn-primary cta" @click="printInvoice()">Print Invoice</button>
                  </div>
                          ...
                          <table class="table table-striped text-body">
                            <thead>
                              <tr class="d-flex">
                                ...
                                <th class="col-2">PRICE {{getCurrencyTitle()}}</th>
                                <th class="col-2">Discount PRICE {{getCurrencyTitle()}}</th>
                                <th class="col-1">QTY</th>
                                <th class="col-2">SUBTOTAL {{getCurrencyTitle()}}</th>
                              </tr>
                            </thead>
                                  ...
                                  <tbody>
                                    ...
                                    >
                                      ...
                                      <td
                                        ...
                                        "
                                      >
                                        {{getCurrencyTitle()}} {{ discountTotal }}
                                      </td>
                                    </tr>
                                    <tr
                                      class="
                                    ...
                                    >
                                      ...
                                      <td
                                        ...
                                        "
                                      >
                                        {{getCurrencyTitle()}} {{ shipping_cost }}
                                      </td>
                                    ...
                                    >
                                      ...
                                      <td
                                        ...
                                        "
                                      >
                                        {{getCurrencyTitle()}} {{ coupon_amount }}
                                      </td>
                                    </tr>
...
export default {
  ...
  methods: {
    ...
    printInvoice() {
      var page_url = "/print-invoice/" + this.$route.params.id;
