...
let routes = [
    {
        ...
        children: [
            ...
            { path: '/admin/country-setting', component: require('./components/admin/Country.vue').default, name: 'country-list', meta: { auth: true }},
            { path: '/admin/state-setting', component: require('./components/admin/State.vue').default, name: 'state-list', meta: { auth: true}},
            { path: '/admin/city-setting', component: require('./components/admin/City.vue').default, name: 'city-list', meta: { auth: true}},
            { path: '/admin/shippment-with-city-setting', component: require('./components/admin/ShippmentWithCity.vue').default, name: 'shippment-with-city-list', meta: { auth: true}},
            ...
            { path: '/admin/import-export', component: require('./components/admin/ImportExport.vue').default, name: 'import-product',meta: { auth: true } },

            { path: '/admin/verify-purchase-code', component: require('./components/admin/purchaseCode.vue').default, name: 'import-product', meta: { auth:true } },
            ...
            { path: '/admin/newslettercontact', component: require('./components/admin/Newslettercontact.vue').default, name: 'NewsletterContact-list', meta: { auth: true } },
