                    ...
                    if (data.status == 'Success') {
                        ...
                        if (data.data.product_video_url != null && data.data.product_video_url != 'null' && data
                            ...
                            image_list_link +=
                                ...
                                data.data.detail[0].title + '">' + data.data.product_video_url + '</a>';
                            image_list +=
                            ...
                            if (data.data.category[0].category_detail != null) {
                                if (data.data.category[0].category_detail.detail != null) {
                                    clone.querySelector(".product-detail-section-cateogory-link").setAttribute(
                                        'href', "/shop?limit=12&category="+data.data.category[0].category_detail.detail[0].category_id);
                        ...
                        if(data.data.detail[0].discount_percentage > 0)
                            bages +='<span class="pre-tag discount">'+data.data.discount_percentage+'%</span>';
                        if(data.data.detail[0].is_featured != "0")
                            bages +='<span class="pre-tag featured-tag">Featured</span>';
