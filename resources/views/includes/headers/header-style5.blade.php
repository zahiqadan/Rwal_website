      <!-- //header style Two -->
      <header id="headerTwo" class="header-area header-five header-desktop d-none d-lg-block d-xl-block">
              ...
              <div class="container">
                  <div class="row">
                              ...
                              <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                      @foreach ($data['currency'] as $currencies)
                                          <a class="dropdown-item selected-currency" data-id="{{ $currencies->id }}"
                      ...
                      <div class="col-12 col-md-6 without-auth-login">
                        ...
                        "><i class="fa fa-lock"
                                          aria-hidden="true"></i>&nbsp;{{ trans('lables.header-login-register') }}</a>
                              </li>
                              </li>
                          </ul>
                      ...
                      <div class="col-12 col-md-6 auth-login">
                          <ul class="link-list pro-header-options">
                              <li>
                                  <p> {{ trans('lables.header-welcome-text') }} <span class="welcomeUsername"></span>
                                  </p>
                              </li>
                              <li class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                      ...
                                      <a class="dropdown-item" href="{{ url('/wallet') }}"
                                          title="{{ trans('lables.header-wallet') }}">{{ trans('lables.header-wallet') }}</a>
                                      @endif
                              ...
                              <div class="search-field-module">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="headerOneCartButton">
                                      @foreach ($data['category'] as $categories)
                                          <a class="dropdown-item"
                                              href="javascript:void(0)">{{ isset($categories->detail[0]->category_name) ? $categories->detail[0]->category_name : '' }}</a>
                                      @endforeach
                                  ...
                                  <div class="search-field-wrap">
                                      ...
                                      <button class="btn btn-secondary swipe-to-top" data-toggle="tooltip"
                                          data-placement="bottom"
                                          title="{{ trans('lables.header-search-products') }}" id="search_button">
                      ...
                      <div class="col-6 col-sm-6 col-md-4 col-lg-3">
                          <ul class="pro-header-right-options">
                              ...
                              <template id="top-cart-product-total-template">
                                  <li>
                                      <span
                                          class="item-summary ">{{ trans('lables.header-total') }}&nbsp;:&nbsp;<span
              ...
              <div class="container">
                  <nav id="navbar_header_1" class="navbar navbar-expand-lg  bg-nav-bar">
                      <div class="navbar-collapse">
                          <a class="navbar-brand home-icon btn-secondary swipe-to-top" href="/"><i
                                  class="fa fa-home"></i></a>
                          @include('includes.headers.main-menu')

                          <a class="nav-link right-menu absolute-right"
                              href="tel:{{ isset(getSetting()['phone_number']) ? getSetting()['phone_number'] : 'N/A' }}">
