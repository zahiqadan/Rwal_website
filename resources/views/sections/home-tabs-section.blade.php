        ...
        <div class="row">
           <div class="col-md-12 p-0">
               <div class="nav" role="tablist" id="tabCarousel">
                   ...
                   <a class="nav-link btn  active show" data-toggle="tab" href="#featured" role="tab" aria-controls="special" aria-selected="true"><span data-toggle="tooltip" data-placement="bottom" title="{{ trans('lables.home-tab-featured') }}">{{ trans('lables.home-tab-featured') }}</span></a>
