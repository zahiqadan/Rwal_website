                                                        ...
                                                        @foreach ($payment_method as $payment_methods)
                                                            @if ($payment_methods->payment_method == 'wallet')
                                                                @if (isset(getSetting()['wallet_setting']) && getSetting()['wallet_setting'] == 'enable')
                                                                    <div class="form-group">
                                                                        <input class="form-check-input payment_method {{ $payment_methods->title }}"
                                                                            type="radio"
                                                                            id="inlineCheckbox{{ $payment_methods->id }}"
                                                                            value="{{ $payment_methods->payment_method }}"
                                                                            name="payment_method">                                                               
                                                                        <label class="form-check-label {{ $payment_methods->title }}"
                                                                            for="inlineCheckbox{{ $payment_methods->id }}">{{ $payment_methods->title }}</label>

                                                                        <label class="form-check-label wallet_amount" for="inlineCheckbox"></label>
                                                                    </div>
                                                                @endif 
                                                            @else
                                                            <div class="form-group">
                                            ...
                                            <div class="bootstrap-basic">
                                                <form class="needs-validation" id="paytm-form"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" id="paytm-charges" name="charges">
                                                        <input type="hidden" id="paytm-user-id" name="user_id">
    ...
    <template id="cartItem-grandtotal-template">
        ...
        <tbody>
            ...
            <tr class="item-price">
                ...
                <td align="right" class="caritem_grandtotal" id="caritem_gtotal">$0</td>
...
@section('script')
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        ...
                        for (i = 0; i < data.data.length; i++) {
                            ...
                            if (data.data[i].product_type == 'variable') {
                                for (k = 0; k < data.data[i].combination.length; k++) {
                                    if (data.data[i].product_combination_id == data.data[i].combination[k]
                                        ...
                                        total_weight += parseFloat(data.data[i].product_weight) * parseFloat(data
                                            .data[i].qty);
                                ...
                                total_weight += parseFloat(data.data[i].product_weight) * parseFloat(data.data[i]
                                    .qty);
                            ...
                            localStorage.setItem('fetch_total_price', total_price);
                            ...
                            if (data.data[i].currency != '' && data.data[i].currency != 'null' && data.data[i]
                                ...
                                if (data.data[i].currency.symbol_position == 'left') {
                                    ...
                                    clone1.querySelector(".caritem_subtotal").setAttribute('currency_code', data
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.status == 'Success') {
                        ...
                        $(".caritem_grandtotal").html(price);
                        localStorage.setItem("couponCart", '');
                        localStorage.setItem("grandPrice", price);
    ...
    <script>
        ...
        function fetchSetting() {
            $.ajax({
                type: 'get',
                url: "{{ url('') }}/api/client/setting?getSameBilling=1",
                headers: {
                    'Authorization': 'Bearer ' + customerToken,
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                    clientid: "{{ isset(getSetting()['client_id']) ? getSetting()['client_id'] : '' }}",
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        console.log('same_setting', data);
                        localStorage.setItem('same_for_billing', data.data.setting_value);
        ...
        function countries() {
            var getSameBilling = localStorage.getItem('same_for_billing');
            console.log('getSameBilling', getSameBilling);
            var url = '';
            if (getSameBilling == '1') {
                url = "{{ url('') }}/api/client/country?getActiveCountry=1";
            } else {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        ...
                        if ($.trim($("#billing_city_hidden").val()) != '') {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        ...
                        for (i = 0; i < data.data.length; i++) {
                            selected = '';
                            if ($.trim($("#billing_city_hidden").val()) != '' && $.trim($(
                                    "#billing_city_hidden").val()) == data.data[i].name) {
                                selected = 'selected';
                            }
                            html += '<option value="' + data.data[i].name + '" ' + selected + '>' + data.data[i]
                                .name + '</option>';
                        }
                        $("#billing_city").html(html);
                        $("#billing_city_hidden").val('');
                    } else if (data.status == 'Error') {
                        toastr.error('{{ trans('response.some_thing_went_wrong') }}');
                    }
                },
        ...
        function city1() {
            ...
            state_id = $("#delivery_state").val() ? $("#delivery_state").val() : state;
            if (state_id == '') {
                $("#delivery_state").html('');
                return;
            }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        ...
                        for (i = 0; i < data.data.length; i++) {
                            selected = '';
                            if ($.trim($("#delivery_city_hidden").val()) != '' && $.trim($(
                                    "#delivery_city_hidden").val()) == data.data[i].name) {
                                selected = 'selected';
                            } else if (data.data[i].id == state) {
                                selected = 'selected';
                            }
                            htmls += '<option value="' + data.data[i].name + '" ' + selected + '>' + data.data[i]
                                .name + '</option>';
                        }
                        $("#delivery_city").html(htmls);
                        $("#delivery_city_hidden").val('');
                        tax();
                    } else if (data.status == 'Error') {
                        toastr.error('{{ trans('response.some_thing_went_wrong') }}');
                    }
        ...
        $("#defaultCheck").click(function() {
            if ($.trim($(this).prop('checked')) == 'true') {
                ...
                $("#billing_city_hidden").val($("#delivery_city").val());
        ...
        $(".createOrder").click(function(e) {
            ...
            if (orderAmount < minimum_order_total)
            {
                ...
                if (payment_method == 'razorpay') {
                    ...
                    var total_amount = parseInt(orderAmount) * 100;
                    var options = {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.status == 'Success') {
                                ...
                                //     window.location.href = "{{ url('/thankyou') }}";
                                if (payment_method == "fygaro") {
                                    var fygaro_button = localStorage.getItem('fygaro_button');
                                        
                                    url = '/api/client/fygaro-jwt';
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            if (data.status == 'Success') {
                                                console.log('fygaro_jwt', data);
                                                var jwt = data.data;
                                                window.location = `${fygaro_button}?jwt=${jwt}`;
                                            } else if (data.status == 'Error') {
                                                toastr.error(
                                                    '{{ trans('response.some_thing_went_wrong') }}'
                                                    );
        ...
        function checkShippingMethod() { 
            $.ajax({
                type: 'get',
                url: "{{ url('') }}/api/client/checkShippingMethod",
                headers: {
                    'Authorization': 'Bearer ' + customerToken,
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                    clientid: "{{ isset(getSetting()['client_id']) ? getSetting()['client_id'] : '' }}",
                ...
                success: function(data) {
                    if (data.status == 'Success') {
                        if (data.data != null) {
                            console.warn('shipping data', data.data);
                            localStorage.setItem('shipping_method', data.data.shipping_methods_type_link)
                        }
                    }
                },
                error: function(data) {
        ...
        var getShippingMehtod = localStorage.getItem('shipping_method');

        function shippingMethodisDefault() {
            if (getShippingMehtod === 'shipmentwithcity') {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ url('') }}/api/client/shippingWithCity",
                    data: {
                        delivery_city: delivery_city,
                    },
                    headers: {
                    ...
                    success: function(data) {
                        if (data.status == 'Success') {
                            if (data != null) {
                                console.warn('fsd', data.shipping_cost);
                                var delayInMilliseconds = 4000; //4 second
                                setTimeout(function() {
                                    exchange_rate = $(".exchange_rate").attr('price');
                                    shipping = 0;
                                    shipping_method_amount = data.shipping_cost * exchange_rate;
                                    ...
                                    if ($.trim($(".caritem_subtotal").attr('currency_position')) == 'left') {
                                        ...
                                        $(".shipping_tax").html(shipping + '' + $(".caritem_subtotal").attr(
                                            'currency_code'));
                                    }
        ...
        function freeShippingPrice () {
            ...
            setTimeout(function() {
                ...
                if (parseFloat(caritem_subtotal) > parseFloat(free_shipping_order_price))
                {
                    ...
                    if ($.trim($(".caritem_subtotal").attr('currency_position')) == 'left') {
                        $(".shipping_tax").html($(".caritem_subtotal").attr('currency_code') + '' +shipping);
                    } else {
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key={{ isset(getSetting()['google_map_api_string']) ? getSetting()['google_map_api_string'] : '' }}&libraries=places&callback=initialize"
        async defer></script>
    <script>
        var markers;
        var myLatlng;
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data.status == 'Success') {
                            ...
                            $('#paytm-user-id').val(localStorage.getItem("customerId"));
                            $('#paytm-charges').val(orderAmount);
                            $('#paytm-form').submit();
        ...
        //                     var order_total = localStorage.getItem('fetch_total_price');
        //                     var orderAmount = '';
        //                     setTimeout(() =>{
        //                         orderAmount = $(".caritem_grandtotal").html();
        //                         orderAmount = parseFloat(orderAmount.match(/-?(?:\d+(?:\.\d*)?|\.\d+)/)[0]);
        //                         console.log("order amount", orderAmount)

        //                         if(parseInt(total) > parseInt(orderAmount)){
        //                             console.log("worlingh in if")
        //                             console.log("order_total in if", orderAmount)
        //                             console.log("worltotalingh in if", total)
        ...
        function fetchFygaroButton() {
            var url = "{{ url('') }}" +
                '/api/client/get-fygaro-button';
            $.ajax({
                type: 'get',
                url: url,
                headers: {
                ...
                beforeSend: function() {},
                success: function(data) {
                    // console.log('fygaro_data', data);
                    if (data.status == 'Success') {
                        var fygaro_button = data.data;
                        console.log('fygaro_button', fygaro_button);
                        localStorage.setItem('fygaro_button', fygaro_button);             
                    }
                },
                error: function(data) {},
            });
