...
class CurrencyRepository implements CurrencyInterface
{
    ...
    public function all()
    {
        try {
            ...
            if (isset($_GET['FindByCurrencyId']) && $_GET['FindByCurrencyId'] != '') {
                $currency = $currency->FindByCurrencyId($_GET['FindByCurrencyId']);
            }
            ...
            if (isset($_GET['sortBy']) && $_GET['sortBy'] != '' && isset($_GET['sortType']) && $_GET['sortType'] != '' && in_array($_GET['sortBy'],$sortBy) && in_array($_GET['sortType'],$sortType)) {
                if ($currency->inActive()) {
                    $currency = $currency->OrderByStatus();
                } else {
