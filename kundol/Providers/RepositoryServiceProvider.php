...
use App\Repository\Web\WalletRepositroy;
...
use App\Repository\Admin\ShippmentWithCityRepository;
...
use App\Repository\Web\NewsletterContactRepository;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(ShippmentWithCityInterface::class, ShippmentWithCityRepository::class);
        ...
        $this->app->bind(WalletInterface::class, WalletRepositroy::class);
        $this->app->bind(NewsletterContactInterface::class, NewsletterContactRepository::class);
