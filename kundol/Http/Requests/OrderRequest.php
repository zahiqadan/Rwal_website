...
class OrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'payment_method' => $rule1.'|in:cod,paypal,stripe,banktransfer,braintree,authorize_net,mollie,sagepay,razorpay,paytm,paystack,wallet,fygaro',
            'cc_number' => 'exclude_if:payment_method,cod,banktransfer,braintree,paytm,mollie,razorpay,paystack,wallet,fygaro|required|integer',
            'cc_expiry_month' => 'exclude_if:payment_method,cod,banktransfer,braintree,paytm,mollie,razorpay,paystack,wallet,fygaro|required|integer',
            'cc_expiry_year' => 'exclude_if:payment_method,cod,banktransfer,braintree,paytm,mollie,razorpay,paystack,wallet,fygaro|required|integer',
            'cc_cvc' => 'exclude_if:payment_method,cod,banktransfer,braintree,paytm,mollie,razorpay,paystack,wallet,fygaro|required|integer',
